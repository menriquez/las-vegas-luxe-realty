...
//$controller = new retsController($action);    // register controller action from filename for consistancy (index for this case)
//$controller->invoke();

$page_title = "Las Vegas Luxe Realty - Premier Las Vegas and Henderson, Nevada Real Estate";
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                        ...
                        try {
                            $controller->invoke();   // invoke controller object to get view

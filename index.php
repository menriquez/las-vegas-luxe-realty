...
include __DIR__. '\mls\controller\retsController.php';
...
$page_desc = "Realtor, Realtors, Real estate agents specializing finding a Realtor in Las Vegas, Nevada  Sell a Home Fast. Homes and Condos For Sale, how to find a Realtor in Las Vegas ";
$page_keys = "real estate, for sale, for rent, best Realtor near Las Vegas, top realtor for buying a new home, selling a home, sell home fast, home selling tips, cost of selling your home, 
              ...
              list of real estate agents, reviews of Realtor, best schools near Las Vegsd, relocation Realtor in Las Vegas";
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WTJ5MQD"
  ...
  <!-- End Google Tag Manager (noscript) -->
	...
	<div id="container" class="main">
        <div id="out">
			...
			<?php include __DIR__.'/includes/nav-bar_new.php'; ?>
          ...
          <div class="col-sm-12 col-ms-12">					
            ...
            <div id="featured_marker"></div>
						...
						<?php include __DIR__.'/includes/accordion.php'; ?>
								  ...
								  <div class="col-sm-12 col-ms-12">      
									  ...
									  <div class=" about-block">                                                                                        
										  ...
										  <div class="col-sm-4 col-ms-4">
											  ...
											  <img class="img-responsive vcenter img-circle center-block ease-left-2" src="https://imagizer.imageshack.com/v2/150x100q90/921/IC1dFN.jpg" alt="Melanie Saljougui, your real estate pro!" />
                                              <img class="img-responsive vcenter scale-img  center-block ease-left-2" src="https://imagizer.imageshack.com/v2/150x100q90/921/IC1dFN.jpg" alt="Melanie Saljougui, your real estate pro!" />
										  </div>
									  </div>
								  </div>
							  </div>  
	...
	<?php include __DIR__.'/includes/bottom_scripts_new.php';  ?>
	<!-- /End Scripts -->

...
<html>
	<head>      
		...
		<!-- styles -->
		<link type="text/css" rel="stylesheet" href="<?= $BASE_WEB_URL ?>/css/bootstrap-plants.css" />
		...
		<link type="text/css" rel="stylesheet" href="<?= $BASE_WEB_URL ?>/css/style-plants.css" />
		<link type="text/css" rel="stylesheet" href="<?= $BASE_WEB_URL ?>/css/accordion.css" />
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
		<link type="text/css" rel="stylesheet" href="<?= $BASE_WEB_URL ?>/css/media.css" />        

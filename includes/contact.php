                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="address">
                                            ...
                                            <address class="styler_color">
                                                ...
                                                <br />
                                                <a href="tel:415-815-9079"  alt="Cell Phone Number"><i class="fa fa-mobile-phone"></i> 415-815-9079</a>
                                                <!-- $moreinfo
                                                f. 214.985.9003<br />
                                                -->
                                                <a class="styler_color" 
                                                    href="mailto:saharsaljougui@gmail.com">saharsaljougui@gmail.com</a>
                                            </address>
                                        </div>
                                    </div>
                                </div>

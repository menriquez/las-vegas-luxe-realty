$(function() {
    ...
    var toasts = [
        new Toast('success', 'toast-bottom-full-width', 'Mail Sent.'),
    ...
    $('#tryMe').click(function () {
        ...
        new Toast('error', 'toast-top-full-width', 'This is positioned in the bottom full width. You can also style the icon any way you like.');
        let t = toasts[0];

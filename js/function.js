...
$(function () {
    ...
    $("#modal-contact-landing").click(function () {
        ...
        let fullname = $('#landing-validForm').find('input[name="fullname"]').val();
        let fullemail = $('#landing-validForm').find('input[name="fullemail"]').val();
        let fullmsg = $('#text-landing-contact').val();
    ...
    async function send_contact_email(url = '', data = {}) {
        ...
        let contact_reply = JSON.stringify(json);
        console.log('Success:', contact_reply);
        update_button_style(contact_reply);

    }
    function update_button_style() {
        return true;
    }
